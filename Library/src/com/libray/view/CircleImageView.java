...
/**
 * @author zhaolin 2014-12-25
 * @Desc:圆形头像
 * 
 *            例子 <com.gogotown.app.sdk.view.CircleImageView
 *            xmlns:app="http://schemas.android.com/apk/res-auto"
 *            //这句话必须加上要不然下面app属性要报错 android:id="@+id/iv_round_head"
 *            android:layout_width="fill_parent"
 *            android:layout_height="fill_parent" android:layout_margin="0dp"
 *            android:src="@drawable/user_default"
 *            app:border_color="@color/white" //圆边颜色 app:border_width="2dp" />
 *            //圆边宽度
 */
public class CircleImageView extends ImageView {
	...
	public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
		...
		mBorderWidth = ViewTool.dip2px(getContext(), 2);
