...
public class ViewTool {
	 ...
	 *            返回键的监听事件 可以传null
	 */
	public static void setTitileInfo(final Activity context, String info,
			OnClickListener listener, int title, int left) {
	...
	public static String imageCompressForBytes(String originalFilePath,
			String newFilePath, int width) {
        if(TextUtils.isEmpty(originalFilePath)) return "";
...
//		int h = bitmap.getHeight();
	...
	public static void showToast(Context context, String content)
	  ...
	  public static void setParams(Window window)
	  {
	  ...
	  public static void setParamsWith(Window window)
	  {
	    LayoutParams lay = window.getAttributes();
	    DisplayMetrics dm = new DisplayMetrics();
	    window.getWindowManager().getDefaultDisplay().getMetrics(dm);
	  ...
	  public static void windowDeploy(int x, int y, Window window)
	  {
	  ...
	  public static void windowDeployRight(int x, int y, Window window)
	  {
	  ...
	  public static void windowDeployLeft(int x, int y, Window window)
	  {
