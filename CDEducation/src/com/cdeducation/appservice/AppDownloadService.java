		...
		executorService.execute(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					if (is != null) {
						File rootFile = new File(Commons.CACHEAPK);
		...
		public void handleMessage(Message msg) {
			...
			if (msg != null) {
				...
				case 1:
					break;
				case 2:
					contentIntent = PendingIntent.getActivity(AppDownloadService.this, msg.arg1, new Intent(AppDownloadService.this, HomeMainActivity.class), 0);
					notification.setLatestEventInfo(AppDownloadService.this, msg.getData().getString("name") + "下载完成", "100%", contentIntent);
				...
				case 3:
					contentIntent = PendingIntent.getActivity(AppDownloadService.this, msg.arg1, new Intent(AppDownloadService.this, HomeMainActivity.class), 0);
					notification.setLatestEventInfo(AppDownloadService.this, msg.getData().getString("name") + "正在下载", download.get(msg.arg1) + "%", contentIntent);
					nm.notify(msg.arg1, notification);
					break;
				case 4:
					Toast.makeText(context, msg.obj.toString(), Toast.LENGTH_SHORT).show();
